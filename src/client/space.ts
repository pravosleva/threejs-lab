...
// See also: https://jasonchen1982.github.io/three.interaction.js/docs/
...
export class Space {
  ...
  cube: THREE.Mesh<THREE.BoxGeometry, THREE.MeshBasicMaterial> & Partial<IInteractionMeshProps>
